...
[Table("price_visual_definition_entries")]
[Index("PriceListId", "ProductVisualDefinitionId", "ValidFrom", Name = "ix_pvd_price_lookup", IsDescending = new[] { false, false, true })]
[Index("ValidFrom", "ValidTo", Name = "ix_pvd_price_validity")]
public partial class PriceVisualDefinitionEntry
{
    [Key]
    ...
    [InverseProperty("PriceVisualDefinitionEntries")]
